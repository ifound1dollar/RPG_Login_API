...
- **Route:** */newaccount/resend-email-verification-code*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
...
- **Route:** */recovery/forgot-password*
- **Method:** POST
...
- **Route:** */recovery/initiate-reset-password*
- **Method:** POST
...
- **Route:** */recovery/submit-reset-password*
- **Method:** POST
...
- **Route:** */account/submit-changed-email*
- **Method:** POST
...
- **Route:** */account/resend-changed-email-verification-code*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
- **Status codes:** 200 on success, 401 for missing or invalid access token, 403 for account currently locked or cannot resend within 60 seconds of previous send, 404 for no account found matching username in token.
...
- **Route:** */account/verify-changed-email*
- **Method:** POST
...
- **Route:** */account/submit-secondary-email*
- **Method:** POST
...
- **Route:** */account/resend-secondary-verification-code*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
- **Status codes:** 200 on success, 401 for missing or invalid access token, 403 for account currently locked or cannot resend within 60 seconds of previous send, 404 for no account found matching username in token.
...
- **Route:** */account/verify-secondary-email*
- **Method:** POST
...
- **Route:** */mfa/regenerate-mfa-recovery-code*
- **Method:** POST
- **Accepts:** Nothing.
...
- **Route:** */mfa/request-mfa-hard-reset*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
...
- **Route:** */mfa/initiate-mfa-hard-reset*
- **Method:** POST
...
- **Route:** */mfa/cancel-mfa-hard-reset*
- **Method:** POST
...
### Ping in launcher
- **Route:** */launcher/ping-in-launcher*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
...
- **Route:** */launcher/notify-launcher-exit*
- **Method:** POST
- **Accepts:** Nothing.
- **Returns:** Nothing.
- **Status codes:** 204 on success, 401 for missing or invalid access token, 403 for account currently locked, 404 for no account found matching username in token.
